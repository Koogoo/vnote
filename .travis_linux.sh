...
# Compile fcitx5
sudo apt-get -y install libsystemd-daemon-dev libdbus-1-dev libxcb-xkb-dev libxcb-ewmh-dev libxcb-xinerama0-dev libxcb-icccm4-dev libwayland-dev libevent-dev
